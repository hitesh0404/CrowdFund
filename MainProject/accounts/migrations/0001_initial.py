    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_detail', models.CharField(default='', max_length=13)),
                ('d_o_b', models.DateField()),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other'), ('N', "Don't want to Mention")], default='N', max_length=2)),
